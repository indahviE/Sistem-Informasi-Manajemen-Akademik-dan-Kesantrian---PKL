...
export declare class PenilaianController {
    ...
    listNilaiUjian(tenantId: string, id: string): Promise<({
        santri: {
            id: string;
            nama: string;
            kelas: {
    ...
    inputNilaiUjian(tenantId: string, id: string, dto: InputNilaiUjianDto): Promise<{
        santri: {
            id: string;
            nama: string;
            nis: string;
    ...
    inputNilaiUjianBulk(tenantId: string, id: string, body: {
        items: InputNilaiUjianDto[];
    ...
    findAllRapor(tenantId: string, santriId?: string, periode?: string): Promise<({
        ...
        updatedAt: Date;
        periode: string;
        ringkasan: import("@prisma/client/runtime/library").JsonValue | null;
